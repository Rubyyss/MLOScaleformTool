"""
Property definitions for GTA V Scaleform Minimap Calculator addon.
...
from bpy.props import (
    FloatProperty, StringProperty, BoolProperty, PointerProperty,
...
class ScaleformCalculatorSettings(bpy.types.PropertyGroup):
    ...
    use_fill: BoolProperty(
        name="Use Fill",
        description="Fill shapes with color",
        default=True
    )
    ...
    use_stroke: BoolProperty(
        name="Use Stroke",
        description="Draw outlines around shapes",
        default=False
    )
...
def unregister_scene_properties():
    ...
    """
    props_to_remove = [
        "scaleform_has_valid_data", "scaleform_width_orig", "scaleform_height_orig",
        "scaleform_width_svg", "scaleform_height_svg", "scaleform_center_x",
        "scaleform_center_y", "scaleform_scaleform_center_x", "scaleform_scaleform_center_y",
        "scaleform_position_svg_x", "scaleform_position_svg_y",
        "scaleform_position_scaleform_x", "scaleform_position_scaleform_y",
