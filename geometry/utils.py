...
class GeometryUtils:
    ...
    def create_arrow_coordinates(center, direction, size=1.0, head_size=0.3):
        ...
        head_right_x = end_x - dir_x * size * head_size - perp_x * size * head_size * 0.5
        head_right_y = end_y - dir_y * size * head_size - perp_y * size * head_size * 0.5
    ...
    def transform_point(point, matrix):
        ...
        new_x = matrix[0][0] * x + matrix[0][1] * y + matrix[0][3]
        new_y = matrix[1][0] * x + matrix[1][1] * y + matrix[1][3]
        
        return GPointF(new_x, new_y)
