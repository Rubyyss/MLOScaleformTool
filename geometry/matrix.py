"""
Matrix transformation classes for GTA V Scaleform Minimap Calculator addon.
...
class GMatrix2D:
    ...
    def transform_points(self, points: List[GPointF]) -> List[GPointF]:
        ...
        This is more efficient than transforming points individually.
    ...
    def transform_rect(self, rect: GRectF) -> GRectF:
        ...
        Note: If there are rotations, the result is the bounding rectangle
        that contains all corner points.
    ...
    def get_inverse(self) -> 'GMatrix2D':
        """
        Return a new matrix that is the inverse of this one.
        
        Returns:
            Inverse matrix, or identity matrix if inversion fails
        """
        result = GMatrix2D()
        # Add the missing row to make a 3x3 matrix
        full_matrix = np.vstack([self.M, [0, 0, 1]])
    ...
    def copy(self) -> 'GMatrix2D':
        ...
        Returns:
            New matrix with the same values
        """
        result = GMatrix2D()
    ...
    def from_array(cls, array: np.ndarray) -> 'GMatrix2D':
        ...
        Args:
            array: NumPy array with matrix data
            
        Returns:
            New matrix initialized with the given array
    ...
    def __mul__(self, other: 'GMatrix2D') -> 'GMatrix2D':
        ...
        Returns:
            New matrix representing the combined transformation
        """
        result = GMatrix2D()
    ...
    def __eq__(self, other) -> bool:
        ...
        Returns:
            True if matrices are equal within epsilon tolerance
        """
    ...
    def __repr__(self) -> str:
        ...
        Returns:
            Formatted string with matrix values
        """
        return (f"GMatrix2D([{self.M[0, 0]:.2f}, {self.M[0, 1]:.2f}, {self.M[0, 2]:.2f}], "
