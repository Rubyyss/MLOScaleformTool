"""
Minimap coordinate calculator for GTA V Scaleform Minimap Calculator addon.
...
class MinimapCalculator:
    ...
    def blender_to_scaleform(self, position: Vector3, svg_scale: float, 
                             svg_width: float, svg_height: float) -> Vector2:
        """
